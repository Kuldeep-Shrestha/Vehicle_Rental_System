 ...
 * @author LENOVO
 */
public class User_Payment_Esewa extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(User_Payment_Esewa.class.getName());

    /**
     * Creates new form User_Payment_
     */
    public User_Payment_Esewa() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new User_Payment_Esewa().setVisible(true));
    }
